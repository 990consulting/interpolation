 ...
 */
public abstract class AbstractASTBlockVisitor<T extends ASTBlockNode, S extends ParserRuleContext> extends AbstractASTNodeVisitor {
    ...
    public AbstractASTBlockVisitor(NanoToASTVisitor master, Function<Stream<ASTStatementNode>, T> constructor) {
        super(master);
