...
public class ASTSingletonVisitorTest extends AbstractVisitorTest {

    private SingletonContext ctx;
    private ASTSingletonVisitor query;
    ...
    public void init() {
        ...
        query = new ASTSingletonVisitor(master);
    ...
    public void operationCase() {
        doTest(OperationContext.class, ASTOperationNode.class);
    }
