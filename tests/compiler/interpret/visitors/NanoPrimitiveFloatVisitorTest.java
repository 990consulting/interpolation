...
import static compiler.interpret.nanosyntax.NanosyntaxParser.FloatPrimitiveContext;
import static org.junit.Assert.assertEquals;
import static org.mockito.Mockito.mock;
import static org.mockito.Mockito.when;

public class NanoPrimitiveFloatVisitorTest extends AbstractVisitorTest {

    private FloatPrimitiveContext ctx;
    private NanoPrimitiveFloatVisitor query;
    ...
    public void init() {
        ...
        query = new NanoPrimitiveFloatVisitor(master);
    }
    ...
    private void doNormalTest(String valueString) {
        ...
        ASTPrimitiveNode<Double> result = query.visit(ctx);
