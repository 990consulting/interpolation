...
public class ASTPrimitiveStringVisitorTest extends AbstractVisitorTest {

    private StringPrimitiveContext ctx;
    private ASTPrimitiveStringVisitor query;
    ...
    public void init() {
        ...
        query = new ASTPrimitiveStringVisitor(master);
    }
